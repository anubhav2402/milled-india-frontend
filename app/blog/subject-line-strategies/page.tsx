...
export const metadata: Metadata = {
  title:
    "Subject Line Strategies That Get Opens: Lessons from 100,000+ Brand Emails",
  description:
    "Data-driven analysis of subject line patterns from 10,000+ top brands. What length, emoji usage, and word choices drive opens.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Data-driven subject line analysis from 100,000+ brand emails.",
